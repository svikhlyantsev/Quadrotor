...
void loop(){
  ...
  // bUpdatedFlags = bUpdatedFlagsShared;
   ...
   Serial.print(",");Serial.print(chan1);Serial.print(",");Serial.print(chan2);Serial.print(",");Serial.print(chan3);Serial.print(",");Serial.print(chan4);Serial.print(",");Serial.println(chan7);//Serial.println(time); 
   }
}
